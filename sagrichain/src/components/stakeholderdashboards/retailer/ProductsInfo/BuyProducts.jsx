...
export default function Tables() {
  ...
  const fetchFarmerProducts = async () => {
    try {
      ...
      const products = await contract.getWholesalerProductsForRetailer();
  ...
  const buyProduct = async (productId) => {
    try {
      ...
      const product = products.find((product) => product.id === productId);
            ...
            // Create formData object to send product details to the server
            ...
            formData.append("stock", selectedQuantity);
            formData.append("draft", 0);
            formData.append("description", product.description);
            formData.append("status", 0);
            formData.append("categories[name]", product.category);
            ...
            setProducts((prevProducts) =>
              prevProducts.map((product) =>
                product.id === productId ? { ...product, stock: product.stock - selectedQuantity } : product
              )
            );
                    ...
                    <tr key={index}>
                      ...
                      <td className="border py-2 align-middle text-xs whitespace-nowrap p-2">
                        <button
                          ...
                          className="bg-[#00ace6] hover:bg-[#00ace6]-100 text-white font-bold py-2 px-4 border-custom-red active:border-red rounded ml-2"
                        >
