  ...
  const fetchAllProducts = async () => {
    try {
      ...
      const [productDetails, quantities] =
        await contract.getConsumerProducts(userAddress);
  ...
  return (
    <div className="bg-[#f1f5f9]">
      <div className="container mx-auto py-8">
        {/* <h1 className="text-2xl font-bold mb-4">Farmers Stores</h1> */}
        <h1 className="mt-20 mb-10 font-semibold text-lg text-blueGray-700">
          Your Purchased History
        </h1>
        <>
          <div className="relative flex flex-col min-w-0 break-words w-full mb-32 shadow-lg rounded bg-white text-blueGray-700">
              ...
              <div className="flex flex-wrap items-center">
                ...
                <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                    {/* {userData && userData.role === "consumer" && ( */}
                      <Link
                        href="/market"
                        className="bg-blue-gray-800 text-white  text-white font-bold py-1 px-2 rounded"
                      >
                        Back to MarketPlace
                      </Link>
                    {/* )} */}
